...
class PrepareCommand extends Command 
{
    ...
    constructor(params, options) 
    {
        ...
        this.route = "dump";
        this.autoload = `${process.cwd()}/.autoload`;
    }
    ...
    loadAutoLoad() 
    {
        if (existsSync(this.autoloadFile))
            return JSON.parse(readFileSync(this.autoloadFile, { encoding: "utf8" }));
